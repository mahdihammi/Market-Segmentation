...
df = pd.read_csv("./clustered_data_customer.csv")
st.set_option('deprecation.showPyplotGlobalUse', False)

st.markdown('<style>body{background-color: Blue;}</style>',unsafe_allow_html=True)
st.title("Prediction of Customer Cluster")
...
if submitted:
    ...
    for c in cluster_df1.drop(['Unnamed: 0','Cluster'],axis=1):
        fig, ax = plt.subplots()
    ...
    # Store balance and purchases in a list
